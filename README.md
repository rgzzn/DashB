...
**DashB** è una dashboard moderna in stile *bento* pensata per trasformare la tua **Apple TV** in un centro di controllo elegante: meteo, calendario e notizie in un’unica vista pulita e immersiva.  
...
- **Design TV‑friendly** con componenti grandi, contrasto elevato e layout bento ottimizzato per il salotto.
